...
urlpatterns += [
    ...
    path('async-store-product/', views.StoreProductAsync.as_view(), name='async-store-product'),
    path('async-store-products/result/<str:task_id>/', views.StoreProductTaskResult.as_view(), name='async_store_product_task_result'),
]