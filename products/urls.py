...
urlpatterns += [
    ...
    path('store-product-list/', views.StoreProductListView.as_view(), name='store-product-list'),
    path('store-product-report/', views.StoreProductReport.as_view(), name='store-product-report'),
]